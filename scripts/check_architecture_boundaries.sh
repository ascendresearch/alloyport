...
if ! rg -q '^fn assignment_dispatch_port_contract' \
    crates/alloyport-server/src/assignment_contract_tests.rs \
    || ! rg -q '^fn sqlite_assignment_store_satisfies_shared_dispatch_contract' \
        crates/alloyport-server/src/assignment_contract_tests.rs \
    || ! rg -q '^fn memory_assignment_store_satisfies_shared_dispatch_contract' \
