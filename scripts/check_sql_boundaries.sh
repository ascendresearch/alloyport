...
# These three mixed modules are acknowledged migration debt. Remove each entry when its SQL moves
...
printf 'SQL boundary check passed; legacy database modules remaining: 3\n'
