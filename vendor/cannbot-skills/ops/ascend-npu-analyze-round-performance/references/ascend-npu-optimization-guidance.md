...
Use this reference when `ascend-npu-analyze-round-performance` needs help turning profiling evidence and IR evidence into concrete potential optimization points.
