...
```bash
python3 <ascend-npu-run-eval-skill-path>/scripts/cli.py compare-result --ref-result <ref_result.pt> --new-result <new_result.pt>
```
...
```bash
python3 <ascend-npu-run-eval-skill-path>/scripts/cli.py compare-result --ref-result <ref_result.pt> --new-result <new_result.pt> --remote user@host:2222 --remote-workdir /tmp/triton-agent
```
