...
install-helper 支持 **11 个官方插件** 和 **101 个 Skills**（动态发现，数量可能随仓库更新而变化）。
...
| 11 | Triton Optimizer | triton-optimizer | triton-agent, triton-agent-optimize, triton-agent-convert |
