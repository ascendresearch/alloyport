...
Server and worker durable assignment contracts share `alloyport_core::ExecutionKind` and
`NetworkPolicy`; persisted JSON stays numeric for compatibility, while Protobuf conversion is
confined to transport mappings.
